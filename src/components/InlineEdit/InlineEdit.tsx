    ...
    function InlineEditField(
        ...
        useLayoutEffect(() => {
            ...
            const updateLayout = () => {
                ...
                const visibleGaps =
                    (extraWidth > 0 ? 6 : 0) + (actionsWidth > 0 ? 6 : 0);
                const wideWidth =
                    labelWidth + extraWidth + actionsWidth + visibleGaps + 8;
        ...
        return (
            <div
                ...
                className={cn(
                    'oui-inline-edit',
                    compact && 'oui-inline-edit-compact',
                    className,
                )}
...
export const InlineEditMultiField = forwardRef<
    HTMLDivElement,
    InlineEditMultiFieldProps
