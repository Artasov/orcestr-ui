...
test('DataTable settings and pinned cells use shared UI primitives', () => {
    ...
    assert.match(
        styles,
        /\.oui-data-table th,[\s\S]*?\.oui-data-table td\s+padding:[\s\S]*?vertical-align: middle/,
    );
    assert.match(
        styles,
        /\.oui-data-table-wrap:focus,[\s\S]*?\.oui-data-table-wrap:focus-visible\s+outline: none/,
    );
    assert.match(
        styles,
        /\.oui-data-table-sort-label\s+display: inline-flex[\s\S]*?transition: background-color 180ms ease, color 180ms ease, box-shadow 180ms ease/,
    );
    ...
    assert.match(
        styles,
        /\.oui-data-table-wrap[\s\S]*?scrollbar-color: var\(--oui-scrollbar-thumb/,
    );
    assert.match(
        styles,
        /\.oui-data-table-wrap[\s\S]*?scrollbar-color: var\(--oui-scrollbar-thumb[\s\S]*?var\(--oui-scrollbar-track, transparent\)/,
    );
    assert.match(
        styles,
        /\.oui-data-table-wrap::-webkit-scrollbar-track[\s\S]*?background: var\(--oui-scrollbar-track, transparent\)/,
    );
    assert.match(
        styles,
        /\.oui-data-table-wrap::-webkit-scrollbar-thumb[\s\S]*?background-color: var\(--oui-scrollbar-thumb,/,
    );
    assert.match(
        styles,
        /\.oui-data-table-wrap::-webkit-scrollbar-thumb:hover[\s\S]*?background-color: var\(--oui-scrollbar-thumb-hover,/,
    );
    assert.match(
        styles,
        /\.oui-data-table tbody tr\s+--oui-data-table-row-bg: var\(--oui-data-table-row-base-bg\)/,
    );
    assert.match(
        styles,
        /\.oui-data-table td\[data-pinned="left"\],[\s\S]*?background: linear-gradient\(var\(--oui-data-table-row-bg\), var\(--oui-data-table-row-bg\)\), var\(--oui-data-table-row-base-bg\)/,
    );
    assert.match(
        styles,
        /\.oui-data-table td\.oui-data-table-expand-cell,[\s\S]*?background: linear-gradient\(var\(--oui-data-table-row-bg\), var\(--oui-data-table-row-bg\)\), var\(--oui-data-table-row-base-bg\)/,
    );
    assert.match(
        styles,
        /\.oui-data-table tbody tr\[data-selected="true"\]\s+--oui-data-table-row-bg: var\(--oui-selected-bg\)[\s\S]*?background: linear-gradient\(var\(--oui-data-table-row-bg\), var\(--oui-data-table-row-bg\)\), var\(--oui-data-table-row-base-bg\)/,
    );
    ...
    assert.match(
        styles,
        /\.oui-data-table-column-settings-row\s+display: flex[\s\S]*?padding: 6px 8px/,
    );
});
